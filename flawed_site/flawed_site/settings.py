"""
Django settings for flawed_site project.
...
INSTALLED_APPS = [
    'assignment_portal.apps.AssignmentPortalConfig',
...
WSGI_APPLICATION = 'flawed_site.wsgi.application'
